                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="" class="flex ms-2 md:me-24">
                            <img src="{{ asset('images/logo.png') }}" class="h-8 me-3" alt="Sch Logo" />
                            {{-- <span
                                class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Sch.</span>
                            --}}
                        </a>
                    </div>
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="#"
                            ...
                            {{-- <span
                                class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-900 dark:text-gray-300">3</span>
                            --}}
                        </a>
                    </li>
                    <li>
